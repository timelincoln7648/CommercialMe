...
-(void) setupTextArray {
    ...
    NSArray *storyPartsArray = [self.text componentsSeparatedByString:@"\n"];
    
    NSLog(@"setting up partsArray");
    for (id story in storyPartsArray ) {
        NSLog(@"new story part! \n\n%@\n\n", story);
    }
    
    NSLog(@"array completed setup");
    self.textArray = storyPartsArray;
